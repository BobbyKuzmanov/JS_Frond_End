function spiceMining(startingYield) {
  ...
  while (startingYield >= 100) {
      ...
      totalSpiceExtracted -= dailyConsumption; // Daily consumption
      startingYield -= 10; // Yield drops by 10 each day
      daysOperated++;
  }

  // Additional consumption after mining is no longer profitable
  totalSpiceExtracted = Math.max(0, totalSpiceExtracted - dailyConsumption);
